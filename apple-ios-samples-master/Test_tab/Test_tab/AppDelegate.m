...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.tabController = [[TabController alloc] initWithNibName:@"TabController" bundle:nil];
    self.tabController.viewControllers= @[self.viewController,self.viewController1];
