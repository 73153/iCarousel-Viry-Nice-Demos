...
@required
- (BOOL)tableView:(UIExpandableTableView *)tableView canExpandSection:(NSInteger)section;//设置当前section是否可折叠
- (BOOL)tableView:(UIExpandableTableView *)tableView needsToDownloadDataForExpandableSection:(NSInteger)section;//设置当前section中的cell是否要下载
- (UITableViewCell<UIExpandingTableViewCell> *)tableView:(UIExpandableTableView *)tableView expandingCellForSection:(NSInteger)section;//获取返回回来的section_cell
...
@required
- (void)tableView:(UIExpandableTableView *)tableView downloadDataForExpandableSection:(NSInteger)section;//下载cell数据（不设置同样可以运行成功）
