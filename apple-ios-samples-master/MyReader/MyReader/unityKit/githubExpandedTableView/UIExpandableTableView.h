...
@optional
//custom the expanded state of section
...
- (void)tableView:(UIExpandableTableView *)tableView didSelectSectionNote:(NSIndexPath *)indexPath expand:(BOOL)expand;
...
@property (nonatomic, assign) BOOL expandingAdjustScrollUnable;
@property (nonatomic, assign) BOOL closingAdjustScrollUnable;
